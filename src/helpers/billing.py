...
if 'sk_test' in STRIPE_SECRET_KEY and not DJANGO_DEBUG:
    raise ValueError('Invalid Stripe Secrete Key for Production. Try checking if you are currently using the test Secret Key')
...
def start_checkout_session(customer='', success_url='', stripe_price_id='', cancel_url='',raw=True):
...
def get_checkout_customer_plan(session_id):
    ...
    custumer_id = checkout_response.customer
